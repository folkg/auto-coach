...
- **Global Circuit Breaker**: If _any_ worker hits a Yahoo 999/429, set a global "Pause" flag in Firestore for 5 minutes. All subsequent tasks fail fast (rescheduled by Cloud Tasks).
