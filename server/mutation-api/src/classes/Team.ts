...
} from "../../../core/src/common/helpers/constants.js";
import { ownershipScoreFunctionFactory } from "../../../core/src/common/services/playerScoreFunctions/playerOwnershipScoreFunctions.service.js";
import { playerStartScoreFunctionFactory } from "../../../core/src/common/services/playerScoreFunctions/playerStartScoreFunctions.service.js";
import {
  flattenArray,
  getNow,
  getProgressBetween,
...
export class Team extends PlayerCollection implements TeamOptimizer {
  ...
  /**
   * Returns a deep clone of team as an ITeam object
   *
   * @public
  ...
  /**
   * positions that already meet or exceed maximum capacity for that position (if applicable)
   *
   * @public
   * @readonly
  ...
  private artificiallyReduceRosterSpots(): void {
  ...
  private processPendingTransactions(): void {
    for (const transaction of this.transactions ?? []) {
      ...
      const isPendingTransaction = ["pending"].includes(transaction[0].status);
